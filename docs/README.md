...
| [`install-for-a-team.md`](install-for-a-team.md) | What the committed project setting does, and the one command each teammate still runs | Rolling DUCAT out to more than one person |
